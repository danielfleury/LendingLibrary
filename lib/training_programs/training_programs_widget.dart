...
import 'training_programs_model.dart';
export 'training_programs_model.dart';

class TrainingProgramsWidget extends StatefulWidget {
  const TrainingProgramsWidget({Key? key}) : super(key: key);

  @override
  _TrainingProgramsWidgetState createState() => _TrainingProgramsWidgetState();
}

class _TrainingProgramsWidgetState extends State<TrainingProgramsWidget> {
  late TrainingProgramsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrainingProgramsModel());
