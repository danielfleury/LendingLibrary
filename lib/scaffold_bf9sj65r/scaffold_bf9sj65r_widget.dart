...
import '/components/container_mjne9zpv_widget.dart';
...
import 'scaffold_bf9sj65r_model.dart';
export 'scaffold_bf9sj65r_model.dart';

class ScaffoldBf9sj65rWidget extends StatefulWidget {
  const ScaffoldBf9sj65rWidget({Key? key}) : super(key: key);

  @override
  _ScaffoldBf9sj65rWidgetState createState() => _ScaffoldBf9sj65rWidgetState();
}

class _ScaffoldBf9sj65rWidgetState extends State<ScaffoldBf9sj65rWidget> {
  late ScaffoldBf9sj65rModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScaffoldBf9sj65rModel());
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 10.0, 0.0, 0.0),
                                  child: Text(
                                    'This is your dashboard. Track inventory, view feedback, training and more.',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Manrope',
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              key: Key(
                                                                                'Keyvnx_${collectionsItem.reference.id}',
                                                                              ),
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container1ka3qrhlWidget(
                                                                                key: Key(
                                                                                  'Key6sr_${rowEquipmentCollectionsRecord.reference.id}',
                                                                                ),
