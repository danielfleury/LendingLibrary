...
import 'container_sae43ci3_model.dart';
export 'container_sae43ci3_model.dart';

class ContainerSae43ci3Widget extends StatefulWidget {
  const ContainerSae43ci3Widget({
    Key? key,
  ...
  @override
  _ContainerSae43ci3WidgetState createState() =>
      _ContainerSae43ci3WidgetState();
}

class _ContainerSae43ci3WidgetState extends State<ContainerSae43ci3Widget> {
  late ContainerSae43ci3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContainerSae43ci3Model());
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    final checkoutsCreateData =
                                      ...
                                      center: _model.textController.text,
                                      location: _model.placePickerValue.latLng,
                                    );
                                    await CheckoutsRecord.collection
                                        .doc()
                                        .set(checkoutsCreateData);
